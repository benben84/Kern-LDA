...
`npm start` opens the Rightform window. Matters are saved in `Documents/Rightform/matters.json`. Filled PDFs are saved in a folder named with the file number, next to that file. New file numbers look like `RF-2026-001`.
